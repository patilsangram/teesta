...
from api_handler.api_handler.exceptions import InvalidDataError, NotImplementedException

@frappe.whitelist()
def handle(resource, data=None, version="1_0_0", req_method="GET",
			filters=None, limit_start=None, limit_page_length=20):
	# TODO request data validations and parsing
	def get():
		""" get doc and return """
		...
		result.append(get_formatted_doc(doc, fields=fields))
